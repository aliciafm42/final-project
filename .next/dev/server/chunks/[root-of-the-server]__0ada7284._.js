...
async function GET(req) {
    try {
        ...
        const actions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$jsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].action.findMany({
            where: {
