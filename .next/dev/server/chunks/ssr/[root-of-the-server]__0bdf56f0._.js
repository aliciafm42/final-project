...
function ProfilePage() {
    const { login, register, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSaveExperience = async ()=>{
        if (!user) {
            alert("Login to save your experience permanently.");
            return;
        }
        try {
            const res = await fetch("/api/save-experience", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
            ...
            else alert(data.error || "Failed to save experience.");
        } catch  {
            alert("Server error while saving experience.");
        }
    };
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    !user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Login to save your experience permanently."
                    }, void 0, false, {
                        fileName: "[project]/app/profile/page.jsx",
                        lineNumber: 139,
                        columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0bdf56f0._.js.map