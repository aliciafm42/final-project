...
function Header() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            fetchUser();
            const listener = {
                "Header.useEffect.listener": ()=>fetchUser()
            }["Header.useEffect.listener"];
            window.addEventListener("userUpdated", listener);
            return ({
                "Header.useEffect": ()=>window.removeEventListener("userUpdated", listener)
            })["Header.useEffect"];
        }
    }["Header.useEffect"], []);
...
_s(Header, "fEsP7tHJuIsOK9Jwd9i3z4y2eQc=", false, function() {
    return [
