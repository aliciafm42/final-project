            ...
            fetch("/api/auth/me").then({
                ...
                "DashboardPage.useEffect": (data)=>{
                    if (data.user) {
                        ...
                        setPoints(data.user.experienceLevel === "beginner" ? 100 : 50);
                    }
                }
            }["DashboardPage.useEffect"]);
        }
...
_s(DashboardPage, "pAZM/tT92r6ATCyW4kuK9GN7HUc=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_0dd60799._.js.map