...
function ProfilePage() {
    _s();
    const { fetchUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        if (res.ok) {
            ...
            setPassword("");
            setExperienceLevel("");
            await fetchUser(); // <-- refresh auth state so header updates immediately
        } else {
...
_s(ProfilePage, "i2QauTxGhtxCLJPtbJyhrcpEC0w=", false, function() {
    return [
