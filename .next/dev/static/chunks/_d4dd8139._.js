...
function Header() {
    _s();
    const { user, fetchUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            const calculatePoints = {
                "Header.useEffect.calculatePoints": async ()=>{
                    if (!user) return setPoints(0);
                    const res = await fetch("/api/actions");
                    const actions = await res.json();
                    const totalPoints = actions.reduce({
                        "Header.useEffect.calculatePoints.totalPoints": (sum, a)=>sum + (user.experienceLevel === "beginner" ? 20 : 10)
                    }["Header.useEffect.calculatePoints.totalPoints"], 0);
                    setPoints(totalPoints);
                }
            }["Header.useEffect.calculatePoints"];
            calculatePoints();
        }
    }["Header.useEffect"], [
        user
...
_s(Header, "fCjdhIBd3GZYHYqZbKkBdKDdfVk=", false, function() {
    return [
...
//# sourceMappingURL=_d4dd8139._.js.map